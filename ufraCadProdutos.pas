...
begin
  try
    ...
    jsonBody.AddPair('preco1', stringreplace(compPRECO1.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('preco2', stringreplace(compPRECO2.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('preco3', stringreplace(compPRECO3.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('preco4', stringreplace(compPRECO4.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('preco5', stringreplace(compPRECO5.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('preco6', stringreplace(compPRECO6.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('pcusto', '');
    jsonBody.AddPair('medio', stringreplace(compMEDIO.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('pesoprod', stringreplace(compPESOPROD.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('pesoprodbruto', stringreplace(compPESOPRODBRUTO.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('maximo', stringreplace(compMAXIMO.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('minimo', stringreplace(compMINIMO.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('codnum', stringreplace(compCODNUM.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('icm', '');
    jsonBody.AddPair('ipi', stringreplace(compIPI.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('ipicmp', stringreplace(compIPICMP.Text,',','.',[rfreplaceall]));
    ...
    jsonBody.AddPair('icms', stringreplace(compICMS.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reducao', stringreplace(compREDUCAO.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('codpal', '');
    jsonBody.AddPair('aliqsg', '');
    jsonBody.AddPair('pisv', stringreplace(compPISV.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('pisc', stringreplace(compPISC.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('cofinsv', stringreplace(compCOFINSV.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('cofinsc', stringreplace(compCOFINSC.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('aliqapro', stringreplace(compALIQAPRO.Text,',','.',[rfreplaceall]));
    ...
    jsonBody.AddPair('icmsc', stringreplace(compICMSC.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('sticmsc', copy(compSTICMSC.Text,1,3));
    jsonBody.AddPair('ean13', compEAN13.Text);
    jsonBody.AddPair('pdif', stringreplace(compPDIF.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('nfce_codcfop', compNFCE_CODCFOP.Text);
    jsonBody.AddPair('reajusta1', stringreplace(compREAJUSTA1.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reajusta2', stringreplace(compREAJUSTA2.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reajusta3', stringreplace(compREAJUSTA3.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reajusta4', stringreplace(compREAJUSTA4.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reajusta5', stringreplace(compREAJUSTA5.Text,',','.',[rfreplaceall]));
    jsonBody.AddPair('reajusta6', stringreplace(compREAJUSTA6.Text,',','.',[rfreplaceall]));
    ...
    jsonBody.AddPair('flt_divisorvolumes', stringreplace(compFLT_DIVISORVOLUMES.Text,',','.',[rfreplaceall]));
    ...
    jsonBody.AddPair('valort', stringreplace(compVALORT.Text,',','.',[rfreplaceall]));
